const CACHE_NAME = "ngombe-herdbook-shell-v18";
const ASSETS = [
  ...
  "./src/storage/local-db.js","./src/storage/local-db.js?build=20260921-03","./src/storage/local-db.js?build=20260922-02",
  "./src/storage/farm-repository.js","./src/storage/farm-repository.js?build=20260921-05","./src/storage/recovery-preflight.js","./src/storage/legacy-claim.js",
